...
>((props, ref) => {
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex h-9 w-full items-center justify-between gap-2 rounded-md border border-input bg-background px-3 py-1 text-sm shadow-xs transition-colors focus:outline-none focus:ring-2 focus:ring-ring/50 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...rest}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        {...rest}
      >
        <SelectPrimitive.ScrollUpButton className="flex items-center justify-center bg-popover py-1">
        ...
        <SelectPrimitive.ScrollDownButton className="flex items-center justify-center bg-popover py-1">
